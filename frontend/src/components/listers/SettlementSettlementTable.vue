    ...
    export default {
        ...
        data: () => ({
            ...
            headers: 
                [
                    { text: "id", value: "id" },
                    { text: "totalUseAmount", value: "totalUseAmount" },
                    { text: "totalChargAmount", value: "totalChargAmount" },
                    { text: "settleFileNm", value: "settleFileNm" },
                    { text: "settleFilePath", value: "settleFilePath" },
                ],
            settlement : [],
            newValue: {},
            tick : true,
